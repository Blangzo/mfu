...
<body>
  ...
  <div class="topnav">
    ...
    <a class="mode" href="intro_to_comparative_federalism.php" id="light_mode">Light Mode</a>
    <a href="dark_intro_to_comparative_federalism.php" id="dark_mode" class="active mode">Dark Mode</a>
  </div>
