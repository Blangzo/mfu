...
<body>
  ...
  <div class="topnav">
    ...
    <a class="mode" href="citizenship_and_statelessness.php" id="light_mode">Light Mode</a>
    <a href="dark_citizenship_and_statelessness.php" id="dark_mode" class="active mode">Dark Mode</a>
  </div>
      ...
      <div class="mb-2 mt-3">
        <h3 class="course">Citizenship and Statelessness by Natalie Brinham, Institute of Statelessness and Inclusion </h3>
          ...
          <h4 class="module">Module 4</h4>
            <h5 class="i1">Lecture</h5>
              <p class="i2"><a href="https://ipfs.io/ipfs/QmXhWYyLBgCxn3nwjf5md6YgUxVCnoLbhFSYGLELgVK2oa?filename=Lesson1_audio2_childhood_statelessness.mp3">English Audio, Part 1</a></p>
            <h5 class="i1">Transcript</h5>
