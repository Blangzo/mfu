...
<body>
  ...
  <div class="topnav">
    ...
    <a class="active mode" href="intro_to_comparative_federalism.php" id="light_mode">Light Mode</a>
    <a href="dark_intro_to_comparative_federalism.php" id="dark_mode" class="mode">Dark Mode</a>
  </div>
