...
<body>
  ...
  <div class="topnav">
    ...
    <a class="mode" href="labor_issues_in_myanmar.php" id="light_mode">Light Mode</a>
    <a href="dark_labor_issues_in_myanmar.php" id="dark_mode" class="active mode">Dark Mode</a>
  </div>
        ...
        <h4 class="course">Taught by Ko Maung and Stephen Campbell</h4>
          ...
          <h4 class="module">Module 1: Introudction</h4>
            <h5 class="i1">Lecture</h5>
              <p class="i2"><a href="https://ipfs.io/ipfs/QmeHaTAP5o8RhRRuF9sYvL1VhhzB1ZJofSC4scveKiqe2t?filename=Labor_Issues_in_Myanmar_Lecture1.m4a">Burmese Audio</a></p>
          ...
          <h4 class="module">Module 4: Patriarchal Capitalism</h4>
            ...
            <h5 class="i1">Readings</h5>
              ...
              <p class="i2"><a href="https://ipfs.io/ipfs/QmfVWh1Q9YAYo786tVyssQZKYAdztRJXpEvw6qQA5B36qd?filename=Ludu_Daw_Amar_Atway_Amyin_Magazine_1987.pdf">Download Link</a></p>
      </div>
  </div>
  <form class="course">
